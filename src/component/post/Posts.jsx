...
import { addToBookmark, deleteBookmarkPost } from "../../redux/slices/bookmarkSlice";
...
export const Posts = ({
  ...
  return (
    <div className="relative fetch-post ml-20  mt-3 gap-2 align-center p-4">
      <div className=" post flex pl-3">
        ...
        <MoreVertOutlinedIcon className="ml-auto" onClick={tooltipHandler} />
        <div
          className={`border rounded-sm absolute right-2 bg-white ${isTooltipVisible}`}
        >
          <div className=" absolute bg-red-400 text-white flex m-1 border-b gap-2 hover:bg-slate-200 cursor-pointer rounded-sm p-1.5 top-2 right-5"  onClick={deletePostHandler}>
            <h1 className="flex">
              Delete <DeleteIcon/>
            </h1>
          </div>
